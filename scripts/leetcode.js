const url_subfolder = "algorithm/LeetCode"
const url_add_difficulty_folder = true;
...
const upload = (token, hook, code, problem, filename, sha, commitMsg, cb = undefined) => {
  const URL = url_add_difficulty_folder
  ? `https://api.github.com/repos/${hook}/contents/${url_subfolder}/${difficulty}/${problem}/${filename}`
  : `https://api.github.com/repos/${hook}/contents/${url_subfolder}/${problem}/${filename}`;
...
async function getUpdatedData(token, hook, directory, filename) {
  const URL = url_add_difficulty_folder
  ? `https://api.github.com/repos/${hook}/contents/${url_subfolder}/${difficulty}/${directory}/${filename}`
  : `https://api.github.com/repos/${hook}/contents/${url_subfolder}/${directory}/${filename}`;
